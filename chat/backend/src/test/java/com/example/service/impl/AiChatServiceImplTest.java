...
class AiChatServiceImplTest {
  ...
  @Mock private ChatClientManager chatClientManager;

  @Mock private ChatClient chatClient;

  @Mock private ChatClient.ChatClientRequestSpec promptRequestSpec;
  ...
  @Mock private ChatErrorHandler errorHandler;

  @Mock private ChatStreamingProperties streamingProperties;

  @Mock private SseEventPublisherImpl sseEventPublisher;
  ...
  void setUp() {
    ...
    lenient()
        .when(conversationService.generateTitleIfNeededAsync(any(), any()))
  ...
  void shouldStreamChatSuccessfully() {
    ...
    lenient()
        .when(modelSelector.getActualModelName("test-provider", null))
    ...
    lenient()
        .doReturn(promptRequestSpec)
        .when(promptRequestSpec)
