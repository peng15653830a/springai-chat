...
class TavilyResponseTest {
    ...
    void shouldCreateTavilyResponse() {
        ...
        List<TavilySearchResult> results = Arrays.asList(
    ...
    void shouldCreateTavilySearchResult() {
        ...
        // When
        TavilySearchResult result = new TavilySearchResult(title, url, content, rawContent, publishedDate, score);
    ...
    void shouldConvertToSearchResult() {
        // Given
        TavilySearchResult tavilyResult = new TavilySearchResult(
            "标题", "https://test.com", "内容", "原始内容", "2024-01-01", 0.9
        );
