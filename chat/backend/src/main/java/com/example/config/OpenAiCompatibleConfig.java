...
public class OpenAiCompatibleConfig {
     ...
     */
    private ChatModel createOpenAiCompatibleModel(String providerName, MultiModelProperties multiModelProperties) {
        ...
        MultiModelProperties.ModelConfig modelConfig = getDefaultModelConfig(providerName, multiModelProperties);
     ...
     * 获取默认模型配置
     */
    private MultiModelProperties.ModelConfig getDefaultModelConfig(String providerName, MultiModelProperties multiModelProperties) {
