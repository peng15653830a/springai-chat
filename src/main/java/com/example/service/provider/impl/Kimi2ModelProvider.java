...
@Slf4j
@Component
public class Kimi2ModelProvider implements ModelProvider {
    ...
    public Kimi2ModelProvider(WebClient.Builder webClientBuilder,
    ...
    public void init() {
        ...
        log.info("Kimi2模型提供者已注册: {}", PROVIDER_NAME);
    }
    ...
    public Flux<SseEventResponse> streamChat(ChatRequest request) {
        log.info("🚀 Kimi2开始流式聊天，模型: {}", request.getModelName());
     ...
     * 调用Kimi2 API
     */
    private Flux<SseEventResponse> callKimi2Api(ChatRequest request) {
    ...
    private Map<String, Object> buildRequestBody(ChatRequest request) {
        ...
        systemMessage.put("content", "你是Kimi，由 Moonshot AI 提供的人工智能助手。");
