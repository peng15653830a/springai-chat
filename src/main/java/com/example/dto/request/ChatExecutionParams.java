...
/**
 * 聊天执行参数类
 * 用于Service层内部方法参数传递，统一替代以下类：
 * - BuildPromptAndStreamChatParams
 * - StreamingChatParams
 * 
 * @author xupeng
 */
...
public class ChatExecutionParams {
     ...
     */
    public static ChatExecutionParams forExecution(String prompt, Long conversationId, 
                                                 boolean deepThinking, String providerName, String modelName) {
        return ChatExecutionParams.builder()
                .prompt(prompt)
