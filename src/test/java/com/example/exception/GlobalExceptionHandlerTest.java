...
class GlobalExceptionHandlerTest {
    ...
    void testHandleMethodArgumentNotValidException() throws NoSuchMethodException {
        ...
        FieldError fieldError1 = new FieldError("testObject", "field1", null, false, null, null, "Field1 error");
        FieldError fieldError2 = new FieldError("testObject", "field2", null, false, null, null, "Field2 error");
    ...
    void testHandleValidationExceptionWithMultipleFieldErrors() throws NoSuchMethodException {
        ...
        Method method = this.getClass().getDeclaredMethod("testHandleValidationExceptionWithMultipleFieldErrors");
        MethodParameter methodParameter = new MethodParameter(method, -1);
        MethodArgumentNotValidException exception = new MethodArgumentNotValidException(methodParameter, bindingResult);
    ...
    void testHandleBindException() {
        // Given
        FieldError fieldError = new FieldError("testObject", "testField", null, false, null, null, "Test error");
