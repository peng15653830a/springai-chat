...
class SearchResultTest {
  ...
  void shouldCreateBasicSearchResult() {
    ...
    // When
    SearchResult result = SearchResult.create(title, content);
  ...
  void shouldCreateCompleteSearchResult() {
    ...
    // When
    SearchResult result = SearchResult.create(title, content, url, score);
  ...
  void shouldCreateWithNullTitle() {
    // When
    SearchResult result = SearchResult.create(null, "content");
  ...
  void shouldCreateWithNullContent() {
    // When
    SearchResult result = SearchResult.create("title", null);
  ...
  void shouldCreateCompleteWithNullUrl() {
    // When
    SearchResult result = SearchResult.create("title", "content", null, 0.8);
  ...
  void shouldCreateCompleteWithNullScore() {
    // When
    SearchResult result = SearchResult.create("title", "content", "https://test.com", null);
  ...
  void shouldTestHashCodeConsistency() {
    // Given
    SearchResult result = new SearchResult("title", "content", "url", 0.8);
  ...
  void shouldHandleEmptyStrings() {
    // Given
    SearchResult result = new SearchResult("", "", "", 0.0);
  ...
  void shouldHandleNegativeScore() {
    // Given
    SearchResult result = new SearchResult("title", "content", "url", -0.5);
  ...
  void shouldHandleScoreGreaterThanOne() {
    // Given
    SearchResult result = new SearchResult("title", "content", "url", 1.5);
  ...
  void shouldHandleVeryLongStrings() {
    ...
    SearchResult result = new SearchResult(longString, longString, longString, 0.5);
    
    // Then
    assertEquals(longString, result.getTitle());
    assertEquals(longString, result.getContent());
  ...
  void shouldCreateWithAllNullValues() {
    // When
    SearchResult basicResult = SearchResult.create(null, null);
