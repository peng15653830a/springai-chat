...
public class AiResponseTest {
    ...
    void testLongContent() {
        ...
        for (int i = 0; i < 10; i++) {
            longContentBuilder.append("This is a very long AI response content that might contain multiple paragraphs and detailed explanations. ");
        }
        for (int i = 0; i < 5; i++) {
            longThinkingBuilder.append("This is a very long thinking process that shows how the AI analyzed the question and came up with the response. ");
        }
