...
class ConversationServiceTest {
    ...
    void testCreateConversation_InvalidUserId() {
        ...
        assertThrows(IllegalArgumentException.class, 
            () -> conversationService.createConversation(null, "标题"));
        assertThrows(IllegalArgumentException.class, 
            () -> conversationService.createConversation(0L, "标题"));
        assertThrows(IllegalArgumentException.class, 
            () -> conversationService.createConversation(-1L, "标题"));
    ...
    void testCreateConversation_InvalidTitle() {
        // When & Then
        assertThrows(IllegalArgumentException.class, 
            () -> conversationService.createConversation(1L, null));
        assertThrows(IllegalArgumentException.class, 
    ...
    void testGetConversationById_InvalidId() {
        // When & Then
        assertThrows(IllegalArgumentException.class, 
            () -> conversationService.getConversationById(null));
        assertThrows(IllegalArgumentException.class, 
            () -> conversationService.getConversationById(0L));
        assertThrows(IllegalArgumentException.class, 
    ...
    void testGetUserConversations_InvalidUserId() {
        // When & Then
        assertThrows(IllegalArgumentException.class, 
            () -> conversationService.getUserConversations(null));
        assertThrows(IllegalArgumentException.class, 
            () -> conversationService.getUserConversations(0L));
        assertThrows(IllegalArgumentException.class, 
            () -> conversationService.getUserConversations(-1L));
    ...
    void testDeleteConversation_InvalidId() {
        // When & Then
        assertThrows(IllegalArgumentException.class, 
            () -> conversationService.deleteConversation(null));
        assertThrows(IllegalArgumentException.class, 
            () -> conversationService.deleteConversation(0L));
        assertThrows(IllegalArgumentException.class, 
    ...
    void testGetConversationMessages_InvalidId() {
        // When & Then
        assertThrows(IllegalArgumentException.class, 
            () -> conversationService.getConversationMessages(null));
        assertThrows(IllegalArgumentException.class, 
            () -> conversationService.getConversationMessages(0L));
        assertThrows(IllegalArgumentException.class, 
            () -> conversationService.getConversationMessages(-1L));
